...
| **Asset** | `public/Union-2.svg` (plus icon; colored via CSS mask) |
...
| `.navbar-manager-icon__plus` | `1.5rem × 1.5rem`, `background-color: #d9d9d9`, `mask: url('/Union-2.svg')` |
...
4. Ensure `public/Union-2.svg` is present.
