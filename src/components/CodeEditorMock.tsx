...
/** Indented rows under `src/` (52px ≈ 3.25rem at 16px root) */
    ...
    >
      ...
      <div className="flex min-h-0 min-w-0 flex-1">
        ...
        <div
          ...
          className="flex min-h-0 min-w-0 flex-1 gap-[1.5rem] overflow-hidden rounded-bl-[0.625rem] rounded-br-[0.625rem] rounded-tl-[1rem] rounded-tr-none border border-white/20 bg-white/[0.09] pl-[3.125rem] pr-[1rem] pt-[1.25rem] pb-[3.25rem] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.12),0_0.25rem_1rem_rgba(0,0,0,0.15)] backdrop-blur-md"
        >
          <div
          ...
          <div
            ...
            role="group"
            aria-label="coding"
            className="flex min-h-0 min-w-0 flex-1 flex-col bg-[#000000]/60"
          >
          <div
